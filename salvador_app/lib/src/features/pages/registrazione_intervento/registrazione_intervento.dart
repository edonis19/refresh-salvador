                          ...
                          onPressed: () async {
                            ...
                            if (confirm == true) {
                              ...
                              try {
                                ...
                                Navigator.of(context)
                                    .pop(); // Hide the loading indicator
                  ...
                  if (AllegatiManager.allegatiTemporanei.isNotEmpty) ...[
                    for (int i = 0;
                      ...
                      InkWell(
                        onTap: () {
                          _openFile(
                              AllegatiManager.allegatiTemporanei[i].path!);
                        },
                        child: Row(
                          children: [
                            Expanded(
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content:
                                  Text('Non esiste il modello nel gestionale'),
                              actions: [
                                TextButton(
                                  child: Text('OK'),
                                  onPressed: () {
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content:
                                  Text('Non esiste la targa nel gestionale'),
                              actions: [
                                TextButton(
                                  child: Text('OK'),
                                  onPressed: () {
